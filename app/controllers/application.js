      ...
      nodes: [
        {
          ...
          link: null,
          caption: i18n.t('forms.application.sitemap.gallery.caption'),
          title: i18n.t('forms.application.sitemap.gallery.title'),
          children: [{
            link: 'i-i-s-gallery-picture-l',
            caption: i18n.t('forms.application.sitemap.gallery.i-i-s-gallery-picture-l.caption'),
            title: i18n.t('forms.application.sitemap.gallery.i-i-s-gallery-picture-l.title'),
            children: null
          }, {
            link: 'i-i-s-gallery-author-l',
            caption: i18n.t('forms.application.sitemap.gallery.i-i-s-gallery-author-l.caption'),
            title: i18n.t('forms.application.sitemap.gallery.i-i-s-gallery-author-l.title'),
            children: null
          }]
        }
      ]
